  ...
  return (
    <div className="bg-gray-50 min-h-full">
      <div className="max-w-2xl mx-auto px-6 py-8 space-y-6">
        ...
        {/* ── Sign Out ────────────────────────────────────────────────────── */}
        <section className="bg-white rounded-xl border border-gray-200 p-6 flex items-center justify-between gap-4">
          <div>
          ...
          <button
            ...
            className="flex items-center gap-2 text-sm font-semibold text-gray-700 border border-gray-300 hover:border-gray-400 hover:text-gray-900 px-4 py-2.5 rounded-lg transition-colors shrink-0"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
